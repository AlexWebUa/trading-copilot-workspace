...
| **P0-7** | Re-baseline: rerun all rules walk-forward with P0-1…P0-6 in place. This is the first trustworthy expectancy number | Evidence loop | S | ✅ DONE 2026-06-10 — `scripts/rebaseline.py`, results in [REBASELINE_2026-06-10.md](REBASELINE_2026-06-10.md). Headline: **no rule shows a positive edge** on BTCUSDT 1h / 2000 bars with honest costs (best IS expectancy −0.015R; OOS samples ≤7 trades — too small for conclusions). The pre-fix backtests' positive numbers were artifacts of the look-ahead + one-sided fees. Rule R&D restarts from this baseline |
